...
**The Quartermaster** is a modern, Warband-aware inventory, currency, profession, and character overview addon for World of Warcraft — built for the **The War Within** / **Midnight** era.

It provides a unified dashboard to track your entire account’s progression, storage, and collectables across all characters, presented in a clean UI designed for fast scanning and daily use.
...
### ⭐ Watchlist
- Keep a curated list of items, reagents, and currencies you care about
...
- **Export tracked reagents** to **Altoholic shopping lists** (directly from profession recipes)
...
### 🎨 UI & Theming
- Modern frame layout and modular UI panels
- Class-coloured or static theme support
...
3. Ensure the folder name is `TheQuartermaster` (not nested).
4. Relaunch the game.

## 🧭 Usage
- Open the main window via the minimap button or `/tq`
- Navigate between sections using the UI navigation:
  - Characters
  - Inventory
  - Bank
  - Currencies
...
- **Copy Item Link**
  - Right-click an item row → Copy Item Link (opens it in chat for easy Ctrl+C)
...
- Special thanks to all beta testers and contributors who helped refine The Quartermaster during its pre-release phases.
