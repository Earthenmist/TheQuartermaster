...
**The Quartermaster** is a comprehensive World of Warcraft addon designed for The War Within (11.0+) that provides powerful Warband bank management and cross-character inventory tracking. Track all your characters' gold, items, collections, and PvE progress in one elegant interface.
...
1. Search for "The Quartermaster" in the CurseForge app
2. Click Install
3. Launch WoW

### **Method 3: Wago Addons**
1. Search for "The Quartermaster" in Wago Addons app
2. Click Install
3. Launch WoW
...
3. Click the **"Scan"** button in The Quartermaster UI
...
Access settings via `/wn config` or ESC → Interface → AddOns → The Quartermaster
...
The Quartermaster uses a modular architecture for maintainability and performance:
...
*The Quartermaster is not affiliated with or endorsed by Blizzard Entertainment.*
