...
ns.DEFAULTS = {
    profile = {
        ...
        -- Legacy theme preferences retained for compatibility; controls are disabled.
        -- Theme mode
        ...
        -- when you open the profession window on that character.
        trackProfessionRecipes = true,
        knowledgeHideCompleted = false,
        comparison = {}, -- Opt-in page views and remembered character/filter selections.
        ...
        watchlistMissingOnly = false,
        watchlistIncludeGuildBank = false, -- Shopping totals; independent of Global Search
        watchlist = {
            items = {},       -- { [itemID] = true }
        ...
        -- Privacy
        allowWealthTransactionRemoval = false, -- Explicit opt-in for history correction
